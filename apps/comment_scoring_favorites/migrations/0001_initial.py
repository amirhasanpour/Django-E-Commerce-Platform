    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comment_child', to='comment_scoring_favorites.comment', verbose_name='والد نطر')),
